...
import type { UpdateEnumItemRequest } from "../model/types";

export const useUpdateEnumItem = () => {
  const queryClient = useQueryClient();

  return useMutation<void, AxiosError, UpdateEnumItemRequest>({
    mutationFn: (payload) => enumTypesService.updateEnumItem(payload),
    onSuccess: () => {

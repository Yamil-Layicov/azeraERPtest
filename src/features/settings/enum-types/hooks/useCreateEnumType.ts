...
import type { CreateEnumTypeRequest } from "../model/types";

export const useCreateEnumType = () => {
  const queryClient = useQueryClient();

  return useMutation<void, AxiosError, CreateEnumTypeRequest>({
    mutationFn: (payload) => enumTypesService.createEnumType(payload),
    onSuccess: () => {
